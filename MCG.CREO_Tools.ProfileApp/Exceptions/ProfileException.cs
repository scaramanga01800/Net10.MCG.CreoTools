...
namespace MCG.CREO_Tools.ProfileApp.Exceptions
{
    public class ProfileException : McgCommonLibException
    {
        ...
        public ProfileException(string CurrentClass = "UnknownClass", Exception CurrentException = null, [CallerMemberName] string CurrentMethod = "UnknownMethod") : base($"Exception in {CurrentClass}.{CurrentMethod} : {CurrentException.Message}")
        {
            TraceLog.AddTraceLog(Message);
        }
        ...
        public new static void SendMessageBox(string CurrentClass = "UnknownClass", Exception CurrentException = null, [CallerMemberName] string CurrentMethod = "UnknownMethod")
        {
            ...
            {
                throw new Exception($"Exception in ProfileException.ProfileException : {ex.Message}");
            }
        }
    }
}
