...
namespace MCG.CREO_Tools.CutLengthApp.Exceptions
{
    public class CutLengthException : McgCommonLibException
    {
        public CutLengthException(string message) : base(message)
        {
            TraceLog.AddTraceLog(Message);
        }

        public CutLengthException(string CurrentClass = "UnknownClass", Exception CurrentException = null, [CallerMemberName] string CurrentMethod = "UnknownMethod") : base($"Exception in {CurrentClass}.{CurrentMethod} : {CurrentException.Message}")
        {
            TraceLog.AddTraceLog(Message);
        }
        ...
        public new static void SendMessageBox(string CurrentClass = "UnknownClass", Exception CurrentException = null, [CallerMemberName] string CurrentMethod = "UnknownMethod")
        {
            ...
            {
                throw new Exception($"Exception in CutLengthException.CutLengthException : {ex.Message}");
            }
        }
    }
}
