...
namespace MCG.CREO_Tools.MiscTools.Exceptions
{
    public class MiscToolsException : McgCommonLibException
    {
        public MiscToolsException(string message) : base(message)
        {
            TraceLog.AddTraceLog(Message);
        }

        public MiscToolsException(string CurrentClass = "UnknownClass", Exception CurrentException = null, [CallerMemberName] string CurrentMethod = "UnknownMethod") : base($"Exception in {CurrentClass}.{CurrentMethod} : {CurrentException.Message}")
        {
            TraceLog.AddTraceLog(Message);
        }
        ...
        public new static void SendMessageBox(string CurrentClass = "UnknownClass", Exception CurrentException = null, [CallerMemberName] string CurrentMethod = "UnknownMethod")
        {
            ...
            {
                throw new Exception($"Exception in MiscToolsException.MiscToolsException : {ex.Message}");
            }
        }
    }
}
